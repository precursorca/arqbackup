...
* February 12, 2026 Version 1.1.4  Improved script to create a blank output file when arqbackup is not installed - to avoid errors in MR log.
* November 21, 2025 Version 1.1.3  Improved client tab formatting.
